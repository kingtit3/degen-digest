#!/usr/bin/env python3
"""
Test the fixed migration logic directly
"""
import json
import logging
import os
...
def run_migration():
    ...
    try:
        logger.info("Starting migration to Cloud SQL...")
...
if __name__ == "__main__":
    try:
        imported_count = run_migration()
        print(
            f"\n✅ Migration completed successfully! Imported {imported_count} items."
        )
    except Exception as e:
        print(f"\n❌ Migration failed: {e}")
        exit(1)
