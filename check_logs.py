...
def check_cloud_run_logs():
    ...
    if success and output.strip():
        ...
        print('gcloud logging read "resource.type=cloud_run_revision AND resource.labels.service_name=degen-digest-dashboard" --limit=10')
...
def main():
    ...
    print("\n💡 Manual commands:")
    print('gcloud logging tail "resource.type=cloud_run_revision AND resource.labels.service_name=degen-digest-dashboard"')
