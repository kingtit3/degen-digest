...
def check_dependencies():
    ...
    required_packages = ["streamlit", "pandas", "sqlmodel", "httpx", "python-dotenv"]
    ...
    if missing_packages:
        ...
        return run_command(
            f"pip install {' '.join(missing_packages)}", "Installing dependencies"
        )
...
def check_environment():
    ...
    required_vars = ["APIFY_API_TOKEN", "OPENROUTER_API_KEY", "NEWSAPI_KEY"]
...
def main():
    ...
    print(
        '4. Check health: python -c "from utils.health_monitor import health_monitor; print(health_monitor.get_health_summary())"'
    )
