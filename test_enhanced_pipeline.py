...
def test_enhanced_viral_predictor():
    ...
    try:
        ...
        key_features = ['engagement_velocity', 'viral_coefficient', 'influence_score', 
                       'sentiment_polarity', 'topic_bitcoin', 'author_influence']
        ...
        if enhanced_predictor.is_trained:
            ...
            print(f"✅ Prediction: {prediction['score']:.3f} (confidence: {prediction['confidence']:.3f})")
        else:
